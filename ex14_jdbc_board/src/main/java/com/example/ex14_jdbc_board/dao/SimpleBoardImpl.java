...
public class SimpleBoardImpl implements SimpleBoardDAO {
    ...
    public List<SimpleBoardDTO> listDAO() {
        ...
        List<SimpleBoardDTO> list = template.query(query,
                new BeanPropertyRowMapper<SimpleBoardDTO>(SimpleBoardDTO.class));
    ...
    public SimpleBoardDTO viewDAO(String id) {
        ...
        SimpleBoardDTO dto = template.queryForObject(query,
                new BeanPropertyRowMapper<SimpleBoardDTO>(SimpleBoardDTO.class));
